...
public class CustomLinkedList<T> implements CustomList<T> {
    ...
    private class CustomLinkedListNode<T> {
        ...
        public CustomLinkedListNode(Object value) {
            this.value = value;
        }
        ...
        public void setPrev(CustomLinkedListNode node) {
            this.prev = node;
        }
        ...
        public CustomLinkedListNode getPrev() {
            return this.prev;
        }
